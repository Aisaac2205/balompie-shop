...
const initializeDatabase = async () => {
  ...
  try {
    console.log('🏀 Inicializando base de datos con datos reales...');

    // Crear usuario admin real - Ernesto
    const saltRounds = 12;
    const ernestoPasswordHash = await bcrypt.hash('ernesto2024', saltRounds);
    ...
    await client.query(`
      ...
      ON CONFLICT (email) DO UPDATE SET 
        ...
        name = $3,
        role = $4
    `, ['ernesto@balompie-shop.com', ernestoPasswordHash, 'Ernesto', 'super_admin']);
    ...
    const teams = [
      ...
      },
      {
        ...
        league: 'Ligue 1',
        foundedYear: 1970,
        achievements: ['11 Ligue 1', '14 Coupe de France'],
        socialMedia: {
          instagram: 'psg',
          twitter: 'PSG_inside',
          facebook: 'PSG'
      ...
      },
      {
        ...
        league: 'Serie A',
        foundedYear: 1897,
        achievements: ['36 Serie A', '2 Champions League', '14 Coppa Italia'],
        socialMedia: {
          instagram: 'juventus',
          twitter: 'juventusfc',
          facebook: 'juventus'
        },
        logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/b/bc/Juventus_Logo_2017_icon.svg',
        primaryColor: '#000000'
      }
    ];
    ...
    console.log('👤 Usuario Ernesto: ernesto@balompie-shop.com / ernesto2024');
    console.log('⚽ Equipos agregados:', teams.length);
    console.log('🛍️ Productos agregados:', products.length);
