...
export function ProductList({
  ...
  const [selectedEquipmentType, setSelectedEquipmentType] = useState('all-equipment');
  ...
  const filteredProducts = products.filter(product => {
    ...
    const matchesTeam = selectedTeam === 'all-teams' || product.team === selectedTeam;
    const matchesEquipment = selectedEquipmentType === 'all-equipment' || product.equipmentType === selectedEquipmentType;
    const matchesProductType = selectedProductType === 'all-types' || product.productType === selectedProductType;
  ...
  const clearFilters = () => {
    ...
    setSelectedEquipmentType('all-equipment');
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <Select value={selectedTeam} onValueChange={setSelectedTeam}>
              ...
              <SelectContent className="bg-white border-gray-300">
                <SelectItem value="all-teams" className="text-gray-900 hover:bg-yellow-50">
                  Todos los equipos
                </SelectItem>
                {teams.map(team => (
            ...
            <Select value={selectedEquipmentType} onValueChange={setSelectedEquipmentType}>
              ...
              <SelectContent className="bg-white border-gray-300">
                <SelectItem value="all-equipment" className="text-gray-900 hover:bg-yellow-50">
            ...
            <Select value={selectedProductType} onValueChange={setSelectedProductType}>
              ...
              <SelectContent className="bg-white border-gray-300">
                <SelectItem value="all-types" className="text-gray-900 hover:bg-yellow-50">
                  Todos los tipos
                </SelectItem>
